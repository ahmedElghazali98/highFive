						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="{{ route('admin.cars.index') }}" class="m-nav__link">
											<span class="m-nav__link-text">{{__('text.cars')}}</span>
										</a>
									</li>
								</ul>
							</div>
...
<h3 class="m-portlet__head-text">
    ...
    <div class="form-group m-form__group row">
			<div class="col-md-3">
				<input type="text" name="user_name_seach"  class="form-control user_name_seach" placeholder="	{{__('text.car_number')}}
                ">
		</div>

	</div>
	<div id="table-container">
        @include('admin.cars.table-data')
            ...
            $.ajax({
                ...
                success: function(data){
					...
					if(data['status'] == true){
                        ...
                        $('.driver_id').val(data['data']['driver_id']).prop('selected', true);
                        $('.color_id').val(data['data']['color_id']).prop('selected', true);
                        $('.type_id').val(data['data']['type_id']).prop('selected', true);
                        $('.selectpicker').selectpicker('refresh');
