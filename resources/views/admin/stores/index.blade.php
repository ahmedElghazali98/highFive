...
<!-- <div class="m-subheader-search">
						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="{{ route('admin.stores.index') }}" class="m-nav__link">
											<span class="m-nav__link-text">{{__('text.stores')}}</span>
										</a>
									</li>
								</ul>
							</div>
		...
		<div class="m-demo__preview  m-demo__preview--btn">
    			...
    			padding-bottom: 15px;margin-left: 5px;margin-right: 5px;"><i class="fa fa-plus" style="padding: 2px;"></i> {{__('text.add_new')}}</button>

                <a href="{{route('admin.stores.export')}}" style="background-color: green;
                border: 1px solid green;height: 41.75px;" class="btn btn-danger m-btn m-btn--custom btnAddCustomer1" style="line-height: 15px;
    			padding-bottom: 15px;"><span><i class="fas fa-file-excel " style="padding: 2px;"></i> {{__('text.export_excel')}}</span></a>
...
<h3 class="m-portlet__head-text">
	...
	<div id="table-container">
        @include('admin.stores.table-data')
            ...
            $.ajax({
                ...
                success: function(data){
					...
					if(data['status'] == true){
                        ...
                        $('#addNewpageForm').find('.storekeeper_id').val(data['data']['storekeeper_id']).prop('selected', true);
                        $('.selectpicker').selectpicker('refresh');
