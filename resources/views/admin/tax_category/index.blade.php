						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="{{ route('admin.tax_category.index') }}" class="m-nav__link">
											<span class="m-nav__link-text">{{__('text.tax_category')}}</span>
										</a>
									</li>
								</ul>
							</div>
...
<h3 class="m-portlet__head-text">
	...
	<div id="table-container">
        @include('admin.tax_category.table-data')
...
@include('admin.tax_category.sub.add')
@stop
