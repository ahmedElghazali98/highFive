            ...
            <form class="addNewpageForm" id="addNewpageForm" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group m-form__group row">
                       ...
                       <!-- <div class="col-md-6">
                            <label>{{__('text.item')}}<span class="required">*</span></label>
                            <select name="price_category_id" class="form-control price_category_id" id="price_category_id">
                                <option value="">{{__('text.item')}}</option>
                        ...
                        <div class="col-md-6">
                            <label>{{__('text.store')}}<span class="required">*</span></label>
                            <select name="store_id" class="form-control store_id selectpicker"
                            data-show-subtext="true" data-live-search="true"
                            id="store_id">
                                <option value="">{{__('text.store')}}</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-valid">
                                <input type="text" name="quantity" class="form-control quantity" placeholder="{{__('text.quantity')}}">
                            </div>
                        </div>
