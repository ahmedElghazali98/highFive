						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="{{ route('admin.items_production.index') }}" class="m-nav__link">
											<span class="m-nav__link-text">{{__('text.items_production')}}</span>
										</a>
									</li>
								</ul>
							</div>
...
<h3 class="m-portlet__head-text">
	...
	<div id="table-container">
        @include('admin.items_production.table-data')
...
@include('admin.items_production.sub.add')
@stop
...
$('.tag_search').on('input',function (e) {
    ...
    if(e.keyCode == 13) {
        ...
        if(value.length==0){
            ...
            $.ajax({
                type: "post",
                url: "/admin/items/search_item_production",
                data: {
                    value:value
                },
...
/************************************************************************************************************* */
        ...
        $(document).on('click', '.updateDetails', function () {
            ...
            $('.rowIdUpdate').val(id);
            $.ajax({
                url: "/admin/items_production/edit",
                type: "get",
                dataType: "JSON",
                data: {
                    id: id
                ...
                success: function(data){
					...
					if(data['status'] == true){
                        ...
                        $('.store_id').val(data['data']['store_id']).prop('selected', true);
                        $('.selectpicker').selectpicker('refresh');
...
/************************************************************************************************************* */
        $('.addNewpageForm').on('submit', function(e){
            ...
            if (id == 0) {
                $.ajax({
                    url: "/admin/items_production/add",
                    type: "post",
					cache:false,
					contentType: false,
					processData: false,
                ...
                $.ajax({
                    url: "/admin/items_production/update",
                    type: "POST",
                    dataType: "JSON",
					cache:false,
					contentType: false,
...
/************************************************************************************************************* */
    ...
    $(document).on('click','.delete',function(e){
		...
		Swal.fire({
				...
				$.ajax({
                url: "/admin/items_production/delete",
                type: "post",
                dataType: "JSON",
                data: {
                    id: id
