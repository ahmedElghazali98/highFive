						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="{{ route('admin.store_item.index') }}" class="m-nav__link">
											<span class="m-nav__link-text">{{__('text.store_item')}}</span>
										</a>
									</li>
								</ul>
							</div>
...
<h3 class="m-portlet__head-text">
    ...
    <div class="form-group m-form__group row">
			<div class="col-md-3">
				<input type="text" name="user_name_seach"  class="form-control user_name_seach" placeholder="{{__('text.store')}}
                ">
		</div>

	</div>
	<div id="table-container">
        @include('admin.store_item.table-data')
...
@include('admin.store_item.sub.add')
@stop
            ...
            $.ajax({
                ...
                success: function(data){
					...
					if(data['status'] == true){
                        ...
                        $('.min_quantity').val(data['data']['min_quantity']);
                        $('.max_quantity').val(data['data']['max_quantity']);
