								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="/users" class="m-nav__link">
											<span class="m-nav__link-text">{{__('text.categoties')}}</span>
										</a>
									</li>
								</ul>
							</div>
...
<h3 class="m-portlet__head-text">
	...
	<div id="table-container">
        @include('admin.categoties.table-data')
...
@include('admin.categoties.sub.add')
@stop
...
/************************************************************************************************************* */        $(document).on('click', '.btnAddCustomer', function () {
            clearFileds();
            $('.modal-title').html('{{__('category.add_new')}}');
        });
            ...
            $.ajax({
                ...
                success: function(data){
					...
					if(data['status'] == true){
						...
						$(".safety_stocks").val(data['data']['safety_stocks']);
                        ...
                        $('#addNewpageForm').find('.manufacture_company_id').val(data['data']['manufacture_company_id']).prop('selected', true);
                        $('#addNewpageForm').find('.unit_id').val(data['data']['unit_id']).prop('selected', true);
                        $('#addNewpageForm').find('.type_category_id').val(data['data']['type_category_id']).prop('selected', true);
