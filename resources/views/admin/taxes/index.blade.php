						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="{{ route('admin.taxes.index') }}" class="m-nav__link">
											<span class="m-nav__link-text">{{__('text.taxes')}}</span>
										</a>
									</li>
								</ul>
							</div>
...
<h3 class="m-portlet__head-text">
	...
	<div id="table-container">
        @include('admin.taxes.table-data')
            ...
            $.ajax({
                ...
                success: function(data){
					...
					if(data['status'] == true){
                        ...
                        $('.rate').val(data['data']['rate'] * 100);
                        $('#addNewpageForm').find('.category_id').val(data['data']['category_id']).prop('selected', true);
                        $('.selectpicker').selectpicker('refresh');
